...
### 기능요구사항
- 글쓰기 기능 구현
  - 로그인 한 사용자는 write.html 에서 글 작성 가능
  - 로그인 하지 않을 경우 불가
  - 작성한 글의 제목을 index.html에 표시
- 세부 글 표시 기능 구현
  - 로그인 한 사용자는 게시글의 내용 확인 가능
  - 그렇지 않은 경우 불가

### 프로그래밍 요구사항
- 404 에러 및 에러 처리 페이지 구현
  - 404 에러 외에도 여러 가능한 에러 상황을 처리
